        ...
        <div className="header__body">
          <Link to="/">
            <div className="body-header__logo">
              ...
              <div className="body-header__text">
                <h2 className="body-header__title">REACT SNEAKERS</h2>
                <p className="body-header__about">Магазин лучших кроссовок</p>
              </div>
            </div>
          </Link>
          <div className="body-header__items">
            ...
            <Link to="orders">
              <div className="body-header__items-profile">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
